...
def get_quandrant_masks():
    ...
    data_savepath = sys_config.project_code_root + "data"

    # Create output directories in data directory
    main_axes_save_basepath = os.path.abspath(os.path.join(data_savepath, 'quadrants_main_axes'))
    between_axes_save_basepath = os.path.abspath(os.path.join(data_savepath, 'quadrants_between_axes'))


    # Already defined in the preprocessing script
    gradient_matching_path = os.path.abspath(os.path.join(data_savepath, 'gradient_matching'))
