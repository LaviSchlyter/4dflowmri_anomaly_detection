...
CONFIG_PATH="/usr/bmicnas02/data-biwi-01/jeremy_students/lschlyter/4dflowmri_anomaly_detection/config/config_cnn_JT.yaml"
...
#conda activate anom
source /scratch_net/tellur/jertan/anaconda/etc/profile.d/conda.sh
conda activate 4Denv_clone
